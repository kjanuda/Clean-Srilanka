!(function(t, e) {
    ...
    var tt = "undefined" != typeof window && "undefined" != typeof document && "undefined" != typeof navigator,
        et = (function() {
            for (var t = ["Edge", "Trident", "Firefox"], e = 0; e < t.length; e += 1)
                if (tt && 0 <= navigator.userAgent.indexOf(t[e])) return 1;
            return 0;
        })(),
        nt =
        tt && window.Promise ?
    ...
    function _t(t) {
        ...
        return {
            height: mt("Height", e, n, i),
            width: mt("Width", e, n, i)
        };
    }
            ...
            modifiers: {
                ...
                applyStyle: {
                    ...
                    onLoad: function(t, e, n, i, o) {
                        ...
                        return e.setAttribute("x-placement", s), Rt(e, {
                        ...
                        return function() {
                            this.state.eventsEnabled ||
                                (this.state = (function(t, e, n, i) {
                                    (n.updateBound = i), jt(t).addEventListener("resize", n.updateBound, {
                                        passive: !0
                                    });
                                    var o = st(t);
                                    return (
    ...
    var Vt = "dropdown",
        ...
        Zt = {
            ...
            SHOWN: "shown" + zt,
            CLICK: "click" + zt,
            CLICK_DATA_API: "click" + zt + Xt,
            KEYDOWN_DATA_API: "keydown" + zt + Xt,
            KEYUP_DATA_API: "keyup" + zt + Xt
        },
        $t = "disabled",
        te = "show",
                    ...
                    if (this._isShown && this._config.backdrop) {
                        if (
                            ((this._backdrop = document.createElement("div")),
                                ...
                                e(this._backdrop).addClass(me), !t)
                        )
                            return;
                        if (!i) return void t();
            ...
            return (
                ...
                (n._activate = function(t) {
                    ...
                    i.hasClass("dropdown-item") ?
                        ...
                        e(this._scrollElement).trigger(sn.ACTIVATE, {
                            relatedTarget: t
                        });
                }),
                (n._clear = function() {
